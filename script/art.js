...
(function() {
  var canonicalGreen, canonicalOrange, canonicalPurple, colorVariance, doubleTriangle, flickerAll, flickerOne, nearColor, root3, sepDist, sidelength, triangleBox, trianglePattern, triangleStreak,
    slice = [].slice;
  ...
  $(document).ready(function() {
    ...
    return T = trianglePattern([50, 475]);
  });

  trianglePattern = function(P1) {
    var P2, P3, P4, P5, P6, P7, T, paper;
    paper = Snap('#art');
